...
if __name__ == "__main__":
    # ================================ add_scalar ================================
    writer = SummaryWriter(comment="add_scalar",
    ...
    writer = SummaryWriter(comment="add_scalars",
                           filename_suffix="_test_tensorboard")
    for i in range(100):
    ...
    # # global_step: 当前步数
    writer = SummaryWriter(comment="add_histogram",
                           filename_suffix="_test_tensorboard")
    for i in range(10):
    ...
    writer.add_image('img_opencv_HWC-shape:{}'.format(img_opencv.shape),
                     img_opencv, 0, dataformats='HWC')
    writer.close()
    #     # ================================ add_images ================================
    #     # 记录多张图片
    ...
    for i in range(16):
        img_batch[i, 0] = np.arange(0, 10000).reshape(
            100, 100) / 10000 / 16 * i
        img_batch[i, 1] = (
